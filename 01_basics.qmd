...
![](images/clipboard-1992692399.png)
...
![](001_DATA/002_DATA_PROCESSED/Screenshot%202026-02-02%20111438.png)
...
```{r} pop %>%    filter(gemnr == 10101) %>%    pull(pop) %>%    mean()}
```
